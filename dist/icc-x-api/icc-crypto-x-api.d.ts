...
export declare class IccCryptoXApi {
  ...
  decryptedShamirRSAKey(hcp: HealthcareParty, notaries: Array<HealthcareParty>): Promise<void>
  /**
  ...
  decryptAndImportAesHcPartyKeysInDelegations(
    ...
    delegations: {
      [key: string]: Array<models.Delegation>
    },
  ...
  loadKeyPairsInBrowserLocalStorage(healthcarePartyId: string, file: Blob): Promise<unknown>
