...
class RSAUtils {
  ...
  loadKeyPairNotImported(id) {
    //TODO decryption
    return JSON.parse(this.storage.getItem(this.rsaLocalStoreIdPrefix + id) || "{}")
  }
  /**
  ...
  loadKeyPairImported(id) {
    return new Promise((resolve, reject) => {
      try {
        const jwkKey = this.storage.getItem(this.rsaLocalStoreIdPrefix + id)
        if (jwkKey) {
