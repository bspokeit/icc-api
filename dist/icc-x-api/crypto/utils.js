...
class UtilsClass {
  constructor() {
    this.textDecoder = TextDecoder ? new TextDecoder() : new encoding.TextDecoder()
    this.textEncoder = TextEncoder ? new TextEncoder() : new encoding.TextEncoder()
  }
  /**
